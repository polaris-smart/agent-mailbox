        ...
        send(
            {
                ...
                "method": "tools/call",
                "params": {
                    "name": "mailbox_register",
                    "arguments": {"agent_id": "WB", "owner": "Workbuddy"},
                },
            }
        )
        read_resp()
        ...
        send(
            {
                ...
                "id": 5,
                "method": "tools/call",
                "params": {"name": "mailbox_check", "arguments": {"agent_id": "WB"}},
            }
        )
        resp = read_resp()
        ...
        send(
            {
                ...
                "params": {
                    ...
                    "arguments": {"from_id": "boss", "subject": "hi", "body": "all"},
                },
            }
        )
        read_resp()
        ...
        send(
            {
                ...
                "params": {
                    "name": "task_move",
                    "arguments": {"from_id": "HS", "task_id": tid, "status": "review"},
                },
            }
        )
        resp = read_resp()
        ...
        send(
            {
                ...
                "params": {
                    "name": "task_move",
                    "arguments": {"from_id": "HS", "task_id": tid, "status": "doing"},
                },
            }
        )
        read_resp()
        ...
        send(
            {
                ...
                "params": {
                    "name": "task_list",
                    "arguments": {"assignee": "WB", "status": "review"},
                },
            }
        )
        resp = read_resp()
        ...
        send(
            {
                ...
                "id": 14,
                "method": "tools/call",
                "params": {"name": "mailbox_list", "arguments": {"agent_id": "WB"}},
            }
        )
        resp = read_resp()
